...
public class BluetoothLeService extends Service {
    public final static String ACTION_GATT_CONNECTED = AppConstants.INTEND_PREFIX + "ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            AppConstants.INTEND_PREFIX + "ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            AppConstants.INTEND_PREFIX + "ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            AppConstants.INTEND_PREFIX + "ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            AppConstants.INTEND_PREFIX + "EXTRA_DATA";
    public static final String DISTANCE = AppConstants.INTEND_PREFIX + "DISTANCE";
    public static final String ANGLE = AppConstants.INTEND_PREFIX + "ANGLE";
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            if (Objects.nonNull(characteristic.getValue())) {
                int angle = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 1);
                int distance = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 0);
